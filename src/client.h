/*
 * Attempt to consolidate unavoidable suck into one file, away from macwc.c.  This
...
client_get_clip(Client *c, struct wlr_box *clip)
{
	...
	*clip = (struct wlr_box){
	...
	xdg_geom = c->surface.xdg->current.geometry;
	clip->x = xdg_geom.x;
	clip->y = xdg_geom.y;
}
...
#endif
	*geom = c->surface.xdg->current.geometry;
}
